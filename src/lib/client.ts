...
export function Environment(name: string): BaseURL {
  return `https://${name}-qb3pc.encr.app`;
}
...
/**
 * Client is an API client for the qb3pc Encore application.
 */
export default class Client {
  public readonly betterAuth: betterAuth.ServiceClient;
  ...
  constructor(target: BaseURL, options?: ClientOptions) {
    ...
    this.betterAuth = new betterAuth.ServiceClient(base);
  }
}
...
export interface ClientOptions {
   ...
   */
  auth?: authAPI.AuthParams | AuthDataGenerator;
}

export namespace betterAuth {
  export type Session = authAPI.AuthData;
...
export type AuthDataGenerator = () =>
  | authAPI.AuthParams
  | Promise<authAPI.AuthParams | undefined>
  | undefined;
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "qb3pc-Generated-TS-Client (Encore/v1.46.10)";
    }
  ...
  async getAuthData(): Promise<CallParameters | undefined> {
    let authData: authAPI.AuthParams | undefined;
